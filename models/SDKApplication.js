...
var DeveloperDB = require('../app/models/SDKDeveloper');
var ApplicationDB = require('../app/models/SDKApplication');
var IOSAppDB = require('../app/models/SDKiosApp');
var AndroidAppDB = require('../app/models/SDKAndroidApp');
                                ...
                                if (err) {
                                    ...
                                    if (appdata.App_Type === "iOS") {
                                        ...
                                        var newIOS = new IOSAppDB({
                                            ...
                                            Project_Id:appdata.Project_Id,
                                            PlistFile:"localhost:8097/"+"./public/plistFiles/"+ AppName + ".plist"
                                        ...
                                        var newAndroid = new AndroidAppDB({
                                            ...
                                            Project_Id:appdata.Project_Id,
                                            JSONFile:"localhost:8097/"+"./public/jsonFiles/"+ AppName11 + ".json"
                                ...
                                IOSAppDB.findOne({Bundle_Identifier: iosData.Bundle_Identifier}).exec().then((BundleIdFound) => {
                                    ...
                                    if (BundleIdFound) {
                                        ...
                                        var newIOS = new IOSAppDB({
                                            ...
                                            PlistFile: "54.210.61.0" + "/ConfiguredFiles/download/" + AppName + ".plist",
                                ...
                                AndroidAppDB.findOne({Package_Name: AndroidData.Package_Name}).exec().then((PackageFound) => {
                                    ...
                                    if (PackageFound) {
                                        ...
                                        var newAndroid = new AndroidAppDB({
                                            ...
                                            AndroidJsonFiles:"54.210.61.0"+"/ConfiguredFiles/download/"+ AppName11 + ".json"
                                ...
                                if (isFound){
                                    ...
                                    IOSAppDB.updateOne({Project_Id: updatedata.Project_Id}, {
                                        $set: {
                                            ...
                                            Modified_Date: Modified_Date,
                                            PlistFile: "54.210.61.0" + "/ConfiguredFiles/download/" + updatedata.App_Name + ".plist",
                                ...
                                var filePath = "./ConfiguredFiles/" + isFound.App_Name + ".json";
                                        ...
                                        AndroidAppDB.updateOne({Project_Id: updatedata.Project_Id}, {
                                            $set: {
                                                ...
                                                Modified_Date: Modified_Date,
                                                AndroidJsonFiles:"54.210.61.0"+"/ConfiguredFiles/download/"+ updatedata.App_Name + ".json"
                                                ...
                                                if (AndroidFound) {
                                                    AndroidAppDB.deleteOne({Project_Id: deleteData.Project_Id}).exec().then((res) => {
                                                        if (res) {
                                                            ...
                                                            callback({response: '0', message: 'Delete Operation Failed4'});
                                                        }
